# generator-bacn [![Build Status](https://secure.travis-ci.org/Schoonology/generator-bacn.png?branch=master)](https://travis-ci.org/Schoonology/generator-bacn)
...
To install generator-bacn from npm, run:

```
$ npm install -g generator-bacn
```
